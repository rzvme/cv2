...
function cv() {
    return {
        ...
        experience: [
            ...
            {
                startTime: "July 2015", endTime: "Present", jobTitle: "Azure Cloud Integration Support Engineer", jobCompany: "Microsoft",
            ...
            {
                startTime: "February 2013", endTime: "June 2015", jobTitle: "Sharepoint Developer", jobCompany: "Stefanini",
                jobDescription: "My responsabilities included customizing Sharepoint solutions for several customers. These customizations mostly required altering or rewriting JavaScript code to implement new features or modify existing features as customer desired."
            },
            {
                startTime: "October 2013", endTime: "February 2015", jobTitle: "Web Developer", jobCompany: "Stefanini",
                jobDescription: "Developed a number of web sites, the majority for private educational institutions in the United Kingdom but also around the world. These responsive web applications were built in ASP.NET MVC and made extensive use of CSS3, multiple JavaScript plugins and JQuery. We also developed an in-house CMS solution which used MSSQL Server for data storage and Entity Framework for data access."
            },
            {
                startTime: "July 2013", endTime: "October 2013", jobTitle: "Web Developer Intern", jobCompany: "Stefanini",
                jobDescription: "Developing a Web Platform for an US Private Equity fund association. My responsabilities included testing and bug fixing, as well as developing new features and pages. The application was built in ASP.NET Web Forms and made use of Entity Framework for data access and Bootstrap for the front end. We used SVN for source control and the application was deployed to a Azure Cloud Service. Later we scaled to multiple regions and use Azure Traffic Manager for request performance routing and resilience."
            }
        ...
        softSkills: "More than two years of experience in direct customer support in an international and multi-cultural environment. Both \
                    ...
                    individual needs and offering the proper help with long term positive effects. Fluent in Romanian and \
                    English. Beginner in French and German.",
        ...
        certifications: [
            ...
            {
                name:"First Certificate in English - Council of Europe",
